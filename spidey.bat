...
echo       SUCK SYKS DICK
echo       ---------
echo     1) GRABBING YOUR FUCKING PUSSY IP
echo     2) TRACKING YOUR FUCKING DNS
echo     3) SCAN YOUR FUCKING PORT
echo     4) DDOS
echo     5) TRACE YOUR FUCKING MAC ADRESS
echo     6) IP ADRESS AND GAY PORTS
echo.
set /p input=
